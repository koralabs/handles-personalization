...
- [ ] BX-002 Implement compiler-safe equivalents for blocked datum-helper semantics (`get_datum`, `has_value_unwrapped`) and refactor call sites while preserving current intent/tests. (Depends: BX-001)
